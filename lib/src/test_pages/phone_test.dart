...
class PhoneTest extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const PhoneTestPage(title: 'URL Launcher'),
    );
  }
}

class PhoneTestPage extends StatefulWidget {
  const PhoneTestPage({super.key, required this.title});
  final String title;

  @override
  State<PhoneTestPage> createState() => _PhoneTestPageState();
}

class _PhoneTestPageState extends State<PhoneTestPage> {
